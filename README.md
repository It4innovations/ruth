...
```bash
git clone --recurse-submodules --branch v2.3-ace-baseline https://github.com/It4innovations/ruth.git
cd ruth
pip install -e .
```
...
```bash
pip install git+https://github.com/It4innovations/ruth.git@v2.3-ace-baseline
```
